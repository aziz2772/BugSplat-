  ...
  void initializePlayer(void)
   {
       ...
       player.sprite = IMG_Load("belha.png");
   ...
   void updatePlayer(void)
 {
  ...
  if (player.timerMort == 0)
  {
    ...
    else if (input.right == 1)
    {
        ...
        {
            player.direction =  RIGHT;
            player.sprite = IMG_Load("belhag.png");
        }
...
void centerScrollingOnPlayer(void)
 {
    ...
    else if (map.startX + SCREEN_WIDTH >= 2500)
    {
        map.startX = 2500 - SCREEN_WIDTH;
    }
    ...
    else if (map.startY + SCREEN_HEIGHT >= 820)
    {
        map.startY = 820 - SCREEN_HEIGHT;
    }
 }
